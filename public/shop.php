...
<input type="hidden" name="bus_central" value="0">
  ...
  <tr>
    <td>
<img src="foo"><br>
<h1>T-shirt ("Gents" fit)</h1>
<p>Swag to show you were there! Tshirt is anthracite grey with three-color print. <i>"Gents" is what the tshirt maker call this model, not our term</i>.</p>
...
<button type="button" class="addToCart btn btn-green" data-id="gents_tshirt"><span class="fa"></span>SEK 200</button>
<input type="hidden" name="gents_tshirt" value="0">
    </td>
    <td>
<img src="foo"><br>
<h1>T-shirt ("Ladies" model)</h1>
<p>Swag to show you were there! Tshirt is anthracite grey with three-color print. <i>"Ladies" is what the tshirt maker call this model, not our term</i>.</p>
...
<button type="button" class="addToCart btn btn-green" data-id="ladies_tshirt"><span class="fa"></span>SEK 200</button>
